...
// Battery 2: External 12V LiON pack report IDs
#define HID_B2_REMAININGCAPACITY     0x30
#define HID_B2_PRESENTSTATUS         0x31

// B2 PresentStatus bit positions (packed into 1 byte, 4 data bits + 4 padding)
#define B2STATUS_CHARGING            0
#define B2STATUS_DISCHARGING         1
#define B2STATUS_PRESENT             2  // ACPresent usage: "12V pack providing voltage"
#define B2STATUS_BATTPRESENT         3
