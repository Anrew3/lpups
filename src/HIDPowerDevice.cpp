...
static const uint8_t _hidReportDescriptor[] PROGMEM = {
    ...
    0xC0,       //     END_COLLECTION (PresentStatus logical)
    0xC0,       //   END_COLLECTION (Sink Battery 1 - 18650 UPS)
    ...
    0x15, 0x00, //     LOGICAL_MINIMUM (0)
    0x26, 0x64, 0x00, // LOGICAL_MAXIMUM (100)
    0x85, HID_B2_REMAININGCAPACITY, // REPORT_ID (0x30)
    0x09, 0x66, //     USAGE (RemainingCapacity)
    0x81, 0xA2, //     INPUT (Data, Variable, Absolute)
    0x09, 0x66, //     USAGE (RemainingCapacity)
    0xB1, 0xA2, //     FEATURE (Data, Variable, Absolute)
    0x05, 0x84, //     USAGE_PAGE (Power Device)
    0x09, 0x02, //     USAGE (PresentStatus)
    0xA1, 0x02, //     COLLECTION (Logical)
    0x85, HID_B2_PRESENTSTATUS, // REPORT_ID (0x31)
    0x05, 0x85, //       USAGE_PAGE (Battery System)
    0x75, 0x01, //       REPORT_SIZE (1)
    0x95, 0x01, //       REPORT_COUNT (1)
    0x15, 0x00, //       LOGICAL_MINIMUM (0)
    ...
    0x09, 0x45, //       USAGE (Discharging)
    0xB1, 0xA2, //       FEATURE
    0x09, 0xD0, //       USAGE (ACPresent) — repurposed: "12V pack voltage present"
    0x81, 0xA2, //       INPUT
    0x09, 0xD0, //       USAGE (ACPresent)
    0xB1, 0xA2, //       FEATURE
    0x09, 0xD1, //       USAGE (BatteryPresent)
    ...
    0x09, 0xD1, //       USAGE (BatteryPresent)
    0xB1, 0xA2, //       FEATURE
    0x95, 0x04, //       REPORT_COUNT (4) — padding to complete the byte
    0x81, 0x01, //       INPUT (Constant)
    0xB1, 0x01, //       FEATURE (Constant)
    0xC0,       //     END_COLLECTION (PresentStatus B2)
    0xC0,       //   END_COLLECTION (Sink Battery 2)
    // ===========================================================
